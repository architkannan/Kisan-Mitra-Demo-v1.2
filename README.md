...
- **Key gaps**: poor visibility into issue types, resolution performance, and adherence to Kisan Mitra’s defined timelines.
...
- Uses static ERPNext datasets (May 2018 – May 2025).
...
- Aging of pending cases (<7, 7–30, >30 days) 
...
🚀 [**Live Demo Dashboard**](https://km-demo-v12.streamlit.app)
